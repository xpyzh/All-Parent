 ...
 * 这里主要验证如下几个问题:
 * 1.同一个classloader能加载统一个class吗? 不能
 ...
 * 4.子lassloader加载的类, 其中该类依赖在父lassloader中存在，这样可行吗?
 *
...
public class Test {
    ...
    public static void demo2() throws Exception {
        ...
        //parent classloader load the class in the frist
        loaderParent.findClass("ChildBean");
        loaderChild.findClass("ChildBean");
        // child classloader load the class in ther first
        //loaderChild.findClass("ChildBean");
        //loaderParent.findClass("ChildBean");
    }
